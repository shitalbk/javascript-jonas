...
percentage values
*/
const populations = [100,23000,79000,35000];
console.log(populations.length === 4);
const percentages = [
  percentageOfWorld1('Turkey',populations[0]),
  percentageOfWorld1('Ireland',populations[1]),
  percentageOfWorld1('England',populations[2]),
  percentageOfWorld1('Russia',populations[3])
];
...
*/
const neighbours = ['Bhutan','Bangladesh','Myanmar','Thailand'];
...
neighbours[neighbours.indexOf('Bangladesh')] = 'Sweden';
console.log(neighbours);
...
const myCountry = {
  ...
  language: 'French',
  population: 68,
  neighbours: ['Belarus','Netherlands','Spain']
};
...
console.log(myCountry.country + ' has '+ myCountry.population + ' million '+
 myCountry.language + '-speaking people, 3 neighbouring countries and a capital called '+
 myCountry['capital']);
...
const myCountryTwo = {
  ...
  describe: function(){
    return (`${this.country} has ${this.population} million ${this.language}-speaking people, 3 neighbouring countries and a capital called ${this.capital}`);
  },
  checkIsland: function(){
    return this.isIsland = this.neighbours.length === 0 ? true:false;
  }
};
console.log(myCountryTwo.describe());
console.log(myCountryTwo.checkIsland());
...
for(let i=0;i<populations.length;i++){
  const perc = percentageOfWorld1('Denmark',populations[i]);
...
while(i<populations.length){
  const per = percentageOfWorld1("Finland",populations[i]);
